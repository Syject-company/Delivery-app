...
// double _kTrackHeight = 14.0;
// double _kTrackWidth = 33.0;
// double _kTrackRadius = _kTrackHeight / 2.0;
// double _kThumbRadius = 10.0;
// double _kSwitchWidth =
//     _kTrackWidth - 2 * _kTrackRadius + 2 * kRadialReactionRadius;
// double _kSwitchHeight = 2 * kRadialReactionRadius + 8.0;
// double _kSwitchHeightCollapsed = 2 * kRadialReactionRadius;
// String kIfTrueText = "on";
// String kIfFalseText = "off";
...
//     _kSwitchWidth = trackWidth;
//     _kThumbRadius = thumbRadius;
//     kIfTrueText = trueText;
//     kIfFalseText = falseText;
//   }
...
//       hasFocus: hasFocus,
//       hovering: hovering,
//       state: state as _CustomSwitchState,
//     );
//   }
...
//       ..hoverColor = hoverColor
//       ..focusColor = focusColor
//       ..activeThumbImage = activeThumbImage as ImageProvider
//       ..onActiveThumbImageError = onActiveThumbImageError
//       ..inactiveThumbImage = inactiveThumbImage as ImageProvider
//       ..onInactiveThumbImageError = onInactiveThumbImageError
//       ..activeTrackColor = activeTrackColor as Color
//       ..inactiveTrackColor = inactiveTrackColor as Color
//       ..configuration = configuration as ImageConfiguration
//       ..onChanged = onChanged
//       ..textDirection = Directionality.of(context)
//       ..additionalConstraints = additionalConstraints
//       ..dragStartBehavior = dragStartBehavior as DragStartBehavior
//       ..hasFocus = hasFocus
//       ..hovering = hovering
//       ..vsync = state;
//   }
...
// class _RenderSwitch extends CircleCheckbox {
//   _RenderSwitch({
//     bool? value,
//     Color? activeColor,
//     Color? inactiveColor,
...
//         _activeThumbImage = activeThumbImage as ImageProvider,
//         _onActiveThumbImageError = onActiveThumbImageError,
//         _inactiveThumbImage = inactiveThumbImage as ImageProvider,
//         _onInactiveThumbImageError = onInactiveThumbImageError,
//         _activeTrackColor = activeTrackColor as Color,
//         _inactiveTrackColor = inactiveTrackColor as Color,
...
//   late Color _cachedThumbColor;
//   late ImageProvider _cachedThumbImage;
//   late ImageErrorListener _cachedThumbErrorListener;
//   late BoxPainter _cachedThumbPainter;
...
//       _kTrackHeight,
//     );
//     final Rect trackRectBorder = Rect.fromLTWH(
//       offset.dx + trackHorizontalPadding,
//       offset.dy + (size.height - _kTrackHeight) / 2.0,
//       size.width - 2.0 * trackHorizontalPadding,
//       _kTrackHeight,
...
//     canvas.drawRRect(trackRRect, paint1);
